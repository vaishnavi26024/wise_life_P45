...
const products = [
  ...
  },
  {
    name: "PURE EV",
    image:
      "https://images.unsplash.com/photo-1593941707882-a5bba14938c7?q=80&w=1600",
  },
];
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <div className="hero-left">
            <img src="/logo.png" alt="Wise Life" className="hero-logo" />
            <p className="hero-tagline">
              <span className="tagline-white">WE </span>
              <span className="tagline-accent">INNOVATE SOLUTIONS </span>
              <span className="tagline-white">FOR EASE OF LIFE</span>
            </p>
            <ArrowDown className="hero-scroll" />
          </div>

          {/* RIGHT STATS – animated */}
